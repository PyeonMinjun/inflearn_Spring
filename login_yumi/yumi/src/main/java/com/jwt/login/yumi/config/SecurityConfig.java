package com.jwt.login.yumi.config;
...
public class SecurityConfig {
    ...
    @Bean
    public BCryptPasswordEncoder bCryptPasswordEncoder(){  // 검증할때  비밀번호를 해쉬로 바꿔서 사용해야함
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .cors((corsCustomizer) -> corsCustomizer.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedMethods(Collections.singletonList("*")); // 메소드 허용 get post...
        ...
        http.sessionManagement((session) -> session
                .sessionCreationPolicy(SessionCreationPolicy.STATELESS)); // stateless으로 관리해야함  중요!
